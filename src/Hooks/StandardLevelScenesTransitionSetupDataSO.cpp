...
MAKE_HOOK_MATCH(StandardLevelScenesTransitionSetupDataSO_Init, &StandardLevelScenesTransitionSetupDataSO::Init, void,
  ...
  clearEventADs();
  TLogger::GetLogger().debug(
      "Got beatmap %s",
      il2cpp_utils::ClassStandardName(reinterpret_cast<Il2CppObject*>(difficultyBeatmap)->klass).c_str());
}

MAKE_HOOK_MATCH(LevelScenesTransitionSetupDataSO_BeforeScenesWillBeActivatedAsync,
                &LevelScenesTransitionSetupDataSO::BeforeScenesWillBeActivatedAsync, System::Threading::Tasks::Task*,
  ...
  //    TLogger::GetLogger().debug("Casting %s",
  //    il2cpp_utils::ClassStandardName(reinterpret_cast<Il2CppObject*>(beatmap)->klass).c_str());
  //
